...
class SegmentsJSONAdapter(AdapterBase):
    """Adapter for generic model prelabel output: {"segments": [...], "classes": [...]}"""
            ...
            anns.append(
                {
                    ...
                    "attributes": {"source": "segments_json"},
                }
            )

        can["annotations"] = anns
        can["extras"]["raw_segments_json"] = payload
        return can
...
ADAPTERS = {
    ...
    "SegmentsJSON": SegmentsJSONAdapter(),
    "OurV1": OurV1Adapter(),
}
